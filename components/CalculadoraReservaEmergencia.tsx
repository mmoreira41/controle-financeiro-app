                ...
                <div className="space-y-4 bg-gray-900/50 p-6 rounded-lg">
                    <div>
                        ...
                        <div className="relative">
                            <select id="tipo-emprego" value={tipoEmprego} onChange={e => setTipoEmprego(e.target.value as any)} className="w-full bg-gray-700 rounded-lg pl-3 pr-10 text-white focus:outline-none focus:ring-2 focus:ring-green-500 appearance-none h-[42px]">
                     ...
                     <div>
                        ...
                        <CurrencyInput id="custo-fixo" value={custoFixo} onValueChange={setCustoFixo} placeholder="R$ 0,00" className="w-full bg-gray-700 rounded-lg px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-green-500 h-[42px]"/>
                    </div>
                     <div>
                        <label htmlFor="salario-mensal" className="block text-sm font-medium text-gray-300 mb-1">Salário Mensal (R$)</label>
                        <CurrencyInput id="salario-mensal" value={salarioMensal} onValueChange={setSalarioMensal} placeholder="R$ 0,00" className="w-full bg-gray-700 rounded-lg px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-green-500 h-[42px]"/>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="percentual-guardado" className="block text-sm font-medium text-gray-300 mb-1">% do Salário Guardado</label>
                             <div className="relative flex items-center bg-gray-700 rounded-lg focus-within:ring-2 focus-within:ring-green-500 h-[42px]">
                                <input
                                    ...
                                    className="w-full h-full bg-transparent pl-3 text-white focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                />
                                <div className="flex items-center pr-3 text-gray-400">
                                    <div className="flex flex-col -space-y-1">
                                        <button type="button" onClick={() => handlePercentChange(1)} className="hover:text-white h-4 flex items-center" aria-label="Aumentar percentual">
                                            <ChevronUp size={16}/>
                                        </button>
                                        <button type="button" onClick={() => handlePercentChange(-1)} className="hover:text-white h-4 flex items-center" aria-label="Diminuir percentual">
                                            <ChevronDown size={16}/>
                                        </button>
                                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select id="meses-seguranca" value={mesesSeguranca} onChange={e => setMesesSeguranca(e.target.value)} className="w-full bg-gray-700 rounded-lg pl-3 pr-10 text-white focus:outline-none focus:ring-2 focus:ring-green-500 appearance-none h-[42px]">
